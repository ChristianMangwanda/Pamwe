...
// the measured width. `children` render on top (e.g. the italic plan title).
export function StripedBanner({ height, radius = 0, stripe = 6, style, children }: StripedBannerProps) {
      ...
      {width > 0 && (
        <Svg width={width} height={height} style={StyleSheet.absoluteFill}>
          <Defs>
            ...
            >
              <Rect x={0} y={0} width={stripe} height={period} fill={colors.line2} />
            </Pattern>
          </Defs>
